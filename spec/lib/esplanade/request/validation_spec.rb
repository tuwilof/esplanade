...
RSpec.describe Esplanade::Request::Validation do
  ...
  describe '#valid!' do
    ...
    context 'content-type is not json' do
      let(:doc) { double(json_schema: double, content_type: 'multipart/form-data;boundary=BOUNDARY') }
      ...
      let(:message) { { method: 'method', path: 'path', content_type: 'multipart/form-data;boundary=BOUNDARY', body: '', error: nil } }
